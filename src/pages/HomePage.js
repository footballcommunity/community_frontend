...
import { dateToString, getKSTDay} from '../utils/dateUtils.js';
const HomePage = () => {
  ...
  return (
    <div>
      <h1> 축구/풋살 용병 게시판 </h1>
      <DateContainer selectedDateDay={getKSTDay(selectedDate)} setSelectedDate={setSelectedDate}></DateContainer>
